                   ...
                   <tbody>
                     <tr id="row_1">
                       <td>
                        ...
                        <td>
                          <input type="text" name="stock[]" id="stock_1" class="form-control" disabled autocomplete="off">
                          <input type="hidden" name="stock_value[]" id="stock_value_1" class="form-control" autocomplete="off">
                        </td>
